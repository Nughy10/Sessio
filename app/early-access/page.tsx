...
const translations = {
  es: {
    ...
    ctaSubtitle: 'Semana 7 • €49/mes de por vida • Primeros 100 coaches • {count}/100 registrados',
  ...
  en: {
    ...
    ctaSubtitle: 'Week 7 • €49/month for life • First 100 coaches • {count}/100 registered',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setName('');
        setTimeout(async () => {
          const countRes = await fetch('/api/early-access');
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-16">
        ...
        <div className="max-w-2xl mx-auto relative">
          ...
          <div className="relative bg-gradient-to-br from-purple-600/80 via-blue-600/80 to-cyan-600/80 backdrop-blur-xl border border-white/20 rounded-3xl p-12 shadow-2xl">
            ...
            <p className="text-blue-100 text-center mb-10 text-lg font-medium">
              {t.ctaSubtitle.replace('{count}', registeredCount.toString())}
            </p>
